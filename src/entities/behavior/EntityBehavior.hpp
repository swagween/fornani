...
inline BehaviorParameters frdog_awakened =  BehaviorParameters("frdog_awakened", 2, 12, false, false, true, 2);
...
inline BehaviorParameters frdog_run =       BehaviorParameters("frdog_run", 4, DEFAULT_FRAMERATE, true, true, false, 16);
