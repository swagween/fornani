...
namespace lookup {
	...
	{arms::WEAPON_TYPE::BRYNS_GUN, audio::Weapon::bryns_gun},
	 {arms::WEAPON_TYPE::PLASMER, audio::Weapon::plasmer},
		 ...
		 {arms::WEAPON_TYPE::TOMAHAWK, audio::Weapon::tomahawk},	 {arms::WEAPON_TYPE::GRAPPLING_HOOK, audio::Weapon::plasmer}, {arms::WEAPON_TYPE::SKYCORPS_AR, audio::Weapon::bryns_gun},
	};
	...
	{arms::WEAPON_TYPE::TUSK,       svc::assetLocator.get().t_bryns_gun},		{arms::WEAPON_TYPE::GRAPPLING_HOOK, svc::assetLocator.get().t_grappling_hook},
	...
	{arms::WEAPON_TYPE::TUSK,       svc::assetLocator.get().t_tusk_projectile},
		...
		{arms::WEAPON_TYPE::GRAPPLING_HOOK, svc::assetLocator.get().t_hook},
	...
	{ arms::WEAPON_TYPE::TUSK, 16 },	   {arms::WEAPON_TYPE::TOMAHAWK, 3},   {arms::WEAPON_TYPE::GRAPPLING_HOOK, 4},
