...
enum class Action { left, right, up, down, main_action, secondary_action, tertiary_action, inspect, arms_switch_left, arms_switch_right, menu_toggle, menu_toggle_secondary };
