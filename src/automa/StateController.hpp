...
enum class Actions { trigger_submenu, save_loaded, exit_submenu, trigger, shutdown, player_death, intro_done, retry, death_mode, console_transition, main_menu, print_stats, screenshot, end_demo };
