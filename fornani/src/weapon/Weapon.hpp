...
constexpr inline ProjectileStats plasmer_stats{5, 240, 17.0, 0.0, 0.0, 0.0, false, false, 0};
...
constexpr inline WeaponAttributes plasmer_attributes{false, false, 3, 30, 9.1f, FUCSHIA, plasmer_barrel};
