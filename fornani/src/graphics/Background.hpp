...
inline std::unordered_map<int, BackgroundBehavior> bg_behavior_lookup{
	{-1, BackgroundBehavior{0, 0.0f, false}},	   {0, BackgroundBehavior{5, 0.3f, true}},		  {1, BackgroundBehavior{5, 0.1f, true}},		 {2, BackgroundBehavior{5, 0.1f, true}},		{3, BackgroundBehavior{5, 0.1f, true}},
	{4, BackgroundBehavior{5, 0.05f, true}},	   {5, BackgroundBehavior{5, 0.1f, true}},		  {6, BackgroundBehavior{5, 0.4f, true}},		 {7, BackgroundBehavior{1, 0.0f, false, 0.2}},	{8, BackgroundBehavior{1, 0.0f, false, 0.0}},
