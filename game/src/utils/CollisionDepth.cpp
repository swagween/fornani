...
void CollisionDepth::print() {
	NANI_LOG_DEBUG(m_logger, "Stream size: {}", stream.size());
	NANI_LOG_DEBUG(m_logger, "Out depths:");
	NANI_LOG_DEBUG(m_logger, "Left: {}", out_depth.left);
	NANI_LOG_DEBUG(m_logger, "Right: {}", out_depth.right);
	NANI_LOG_DEBUG(m_logger, "Top: {}", out_depth.top);
	NANI_LOG_DEBUG(m_logger, "Bottom: {}", out_depth.bottom);
}
