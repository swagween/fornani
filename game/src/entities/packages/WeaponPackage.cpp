...
void WeaponPackage::update(automa::ServiceProvider& svc, world::Map& map, enemy::Enemy& enemy, bool desired) {
	...
	weapon.get()->set_firing_direction(desired ? enemy.get_desired_direction() : enemy.get_actual_direction());
}
