...
void WardrobeWidget::update(automa::ServiceProvider& svc, player::Player& player) {
	auto p{player.catalog.wardrobe.get_variant(player::ApparelType::pants)};
	NANI_LOG_DEBUG(m_logger, "pants variant: {}", p);
	...
	case 2: m_sprites.pants.setTexture(svc.assets.get_texture("wardrobe_chalcedony_skirt")); break;
	case 3: m_sprites.pants.setTexture(svc.assets.get_texture("wardrobe_punk_pants")); break;
	default: break;
	}
	...
	case 1: m_sprites.hairstyle.setTexture(svc.assets.get_texture("wardrobe_punk_hair")); break;
	case 2: m_sprites.hairstyle.setTexture(svc.assets.get_texture("wardrobe_ponytail")); break;
	default: break;
	}
	...
	case 1: m_sprites.shirt.setTexture(svc.assets.get_texture("wardrobe_chalcedony_tee")); break;
	case 2: m_sprites.shirt.setTexture(svc.assets.get_texture("wardrobe_punk_shirt")); break;
	default: break;
	}
