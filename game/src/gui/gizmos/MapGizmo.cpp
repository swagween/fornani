...
MapGizmo::MapGizmo(automa::ServiceProvider& svc, world::Map& map) : Gizmo("Minimap"), m_minimap{std::make_unique<MiniMap>(svc)}, m_sprite{svc.assets.t_map_gizmo}, m_map_screen(svc, 48, 1) {
