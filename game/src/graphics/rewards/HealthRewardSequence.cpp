...
HealthRewardSequence::HealthRewardSequence(automa::ServiceProvider& svc, player::Player& player, world::Map& map, sf::Vector2f hud_point)
	: IRewardSequence{svc, player, map}, Animatable{svc, "health_increase", {54, 47}}, m_case{svc, "health_increase_case", {54, 47}}, m_ui_heart{svc, "heads_up_display_hearts", {11, 11}},
