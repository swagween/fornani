...
void Transition::update(player::Player& player) {
	if ((is(TransitionState::black) || is(TransitionState::fading_to_black) || is(TransitionState::fading_out)) && !player.controller.walking_autonomously() && player.grounded() && !player.has_flag_set(player::State::trial)) {
