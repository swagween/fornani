...
class Application {
  public:
	explicit Application(char** argv, const char * loading_screen = "/image/gui/loading.png")  : finder(argv), t_loading(finder.resource_path + loading_screen), loading(t_loading) {};
