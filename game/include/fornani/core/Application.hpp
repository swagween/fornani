...
class Application : public UniquePolymorphic {
  public:
	explicit Application(char** argv, char const* loading_screen = "/image/gui/loading.png") : m_finder(argv), m_context{.settings{m_finder}, .localization{m_finder}, .version{m_game_info, m_finder}} {};
