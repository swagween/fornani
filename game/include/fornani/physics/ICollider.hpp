...
enum class ColliderFlags { custom_properties, changed, intangible, simple, no_physics, registered, crushed, landed, in_water, submerged, sinking, no_update, left_walljump, right_walljump, gravity, in_goo, momentum, encumbered };
...
enum class ColliderTrait { circle, player, enemy, npc, secondary, block, particle, platform, pushable, chest };
