...
enum class AbilityType : std::uint8_t { jump, slide, roll, wallslide, vision, dash, doublejump, dash_kick, double_dash, omnidirectional_dash, walljump, dive, corner_flip, invalid };
