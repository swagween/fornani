...
class Loot {
  public:
	Loot() = default;
	Loot(automa::ServiceProvider& svc, player::Player& player, sf::Vector2<int> drop_range, float probability, sf::Vector2f pos, int delay_time = 0, bool special = false, int special_id = 0);
