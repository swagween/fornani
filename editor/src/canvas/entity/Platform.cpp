...
std::unique_ptr<Entity> Platform::clone() const override { return std::make_unique<Platform>(*this); }

void Platform::serialize(dj::Json& out) override {
...
void Platform::unserialize(dj::Json& in) override { Entity::unserialize(in); }

void Platform::expose() override {
	Entity::expose();
